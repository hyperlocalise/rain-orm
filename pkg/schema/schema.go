...
// GeneratedAlwaysAsIdentity marks the column as a PostgreSQL identity column (GENERATED ALWAYS AS IDENTITY).
// Implicitly sets the column as NOT NULL and AUTOINCREMENT.
func (c *Column[T]) GeneratedAlwaysAsIdentity() *Column[T] {
	c.def.IdentityAlways = true
	c.def.IdentityDefault = false
	c.def.Nullable = false
	c.def.AutoIncrement = true
	return c
}

// GeneratedByDefaultAsIdentity marks the column as a PostgreSQL identity column (GENERATED BY DEFAULT AS IDENTITY).
// Implicitly sets the column as NOT NULL and AUTOINCREMENT.
func (c *Column[T]) GeneratedByDefaultAsIdentity() *Column[T] {
	c.def.IdentityAlways = false
	c.def.IdentityDefault = true
	c.def.Nullable = false
	c.def.AutoIncrement = true
	return c
}
...
// Eq compares this concatenation expression to a value.
func (c ConcatExpr) Eq(value any) ComparisonExpr {
	return Eq(c, value)
}

// Ne compares this concatenation expression to a value.
func (c ConcatExpr) Ne(value any) ComparisonExpr {
	return Ne(c, value)
}

// Gt compares this concatenation expression to a value.
func (c ConcatExpr) Gt(value any) ComparisonExpr {
	return Gt(c, value)
}

// Gte compares this concatenation expression to a value.
func (c ConcatExpr) Gte(value any) ComparisonExpr {
	return Gte(c, value)
}

// Lt compares this concatenation expression to a value.
func (c ConcatExpr) Lt(value any) ComparisonExpr {
	return Lt(c, value)
}

// Lte compares this concatenation expression to a value.
func (c ConcatExpr) Lte(value any) ComparisonExpr {
	return Lte(c, value)
}

// Asc returns an ascending sort expression.
func (c ConcatExpr) Asc() OrderExpr {
	return Asc(c)
}

// Desc returns a descending sort expression.
func (c ConcatExpr) Desc() OrderExpr {
	return Desc(c)
}

// IsNull creates an IS NULL predicate.
func (c ConcatExpr) IsNull() NullCheckExpr {
	return IsNull(c)
}

// IsNotNull creates an IS NOT NULL predicate.
func (c ConcatExpr) IsNotNull() NullCheckExpr {
	return IsNotNull(c)
}
